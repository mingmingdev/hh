...
public class NotificationActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
    ...
    private void initView() {
        ...
        mToolbar.inflateMenu(R.menu.natification_toolbar_menu);//设置右上角的填充菜单
         ...
         * 对三个Fragment进行设置
         */
        mPager = (ViewPager) findViewById(R.id.notification_viewpager);
        //// TODO:准备tab的切换内容
        TabLayout tabBar = (TabLayout)findViewById(R.id.notification_tab_bar);
